...
usage() {
	this=$1
	cat <<EOF
$this: Download binaries for kba-tools/besu-k8s-hooks

Usage: $this [-b] bindir [-d] [tag]
    -b sets bindir or installation directory, defaults to './bin'
    -d turns on debug logging

    [tag] is a tag from https://github.com/kba-tools/besu-k8s-hooks/releases.
...
get_binaries() {
	case "$PLATFORM" in
	linux/amd64) BINARIES="besu-config-generator" ;;
	linux/arm64) BINARIES="besu-config-generator" ;;
	*)
